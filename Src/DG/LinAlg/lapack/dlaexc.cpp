...
/* Computing MAX */
	d__2 = std::abs(d__[2]), d__3 = std::abs(d__[6]), d__2 = std::max(d__2,d__3), d__3 = 
		(d__1 = d__[10] - t11, std::abs(d__1));
...
/* Computing MAX */
	d__2 = std::abs(d__[1]), d__3 = std::abs(d__[2]), d__2 = std::max(d__2,d__3), d__3 = 
		(d__1 = d__[0] - t33, std::abs(d__1));
	if (std::max(d__2,d__3) > thresh) {
	    goto L50;
	}
...
/* Computing MAX */
	d__1 = std::abs(d__[2]), d__2 = std::abs(d__[6]), d__1 = std::max(d__1,d__2), d__2 = 
		std::abs(d__[3]), d__1 = std::max(d__1,d__2), d__2 = std::abs(d__[7]);
