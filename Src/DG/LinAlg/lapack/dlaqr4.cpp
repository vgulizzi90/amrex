...
/*        .    NWR.GE.3.) ==== */
	...
	nwr = ilaenv_(&c__13, "DLAQR4", n, ilo, ihi, lwork);
	nwr = std::max(2,nwr);
/* Computing MIN */
...
/*        .    and greater than or equal to two as required. ==== */
	...
	nsr = ilaenv_(&c__15, "DLAQR4", n, ilo, ihi, lwork);
/* Computing MIN */
...
/*        ==== DLAHQR/DLAQR0 crossover point ==== */
	...
	nmin = ilaenv_(&c__12, "DLAQR4", n, ilo, ihi, lwork);
	nmin = std::max(11,nmin);

/*        ==== Nibble crossover point ==== */

	nibble = ilaenv_(&c__14, "DLAQR4", n, ilo, ihi, lwork);
	nibble = std::max(0,nibble);

/*        ==== Accumulate reflections during ttswp?  Use block */
/*        .    2-by-2 structure during matrix-matrix multiply? ==== */

	kacc22 = ilaenv_(&c__16, "DLAQR4", n, ilo, ihi, lwork);
