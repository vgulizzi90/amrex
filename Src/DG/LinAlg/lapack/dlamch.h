#ifndef BL_LAPACK_DLAMCH_H_
#define BL_LAPACK_DLAMCH_H_
	...
	doublereal *rmax)
{
    ...
    /* Format strings */
    /*
    char fmt_9999[] = "(//\002 WARNING. The value EMIN may be incorre"
    ...
    */
    ...
    integer gpmin;
    doublereal third;
    doublereal lrmin, lrmax;
    doublereal sixth;
    logical lieee1;
    integer ngnmin, ngpmin;

    /* Fortran I/O blocks */
    //cilist io___58 = { 0, 6, 0, fmt_9999, 0 }; // VG COMMENTED
...
/*            ( A guess; no known machine ) */
	    ...
	    if ((i__1 = ngpmin - ngnmin, std::abs(i__1)) == 1) {
...
/*         ( A guess; no known machine ) */
	...
	first = FALSE_;
/*
// Comment out this if block if EMIN is ok // VG COMMENTED
	if (iwarn) {
	    first = TRUE_;
	    s_wsfe(&io___58);
