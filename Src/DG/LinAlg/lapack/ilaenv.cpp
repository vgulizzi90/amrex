...
//integer ilaenv_(integer *ispec, const char *name__, const char *opts, integer *n1, integer *n2, integer *n3, integer *n4)
...
/*     12 <= ISPEC <= 16: xHSEQR or one of its subroutines. */
    ...
    ret_val = iparmq_(ispec, n1, n2, n3, n4)
	    ;
    return ret_val;
